...
public final class SplashBinding implements ViewBinding {
  ...
  @NonNull
  public final LottieAnimationView iconLoad;

  private SplashBinding(@NonNull LinearLayout rootView, @NonNull LottieAnimationView iconLoad) {
  ...
  public static SplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.iconLoad;
      LottieAnimationView iconLoad = ViewBindings.findChildViewById(rootView, id);
      if (iconLoad == null) {
        break missingId;
      }

      return new SplashBinding((LinearLayout) rootView, iconLoad);
    }
