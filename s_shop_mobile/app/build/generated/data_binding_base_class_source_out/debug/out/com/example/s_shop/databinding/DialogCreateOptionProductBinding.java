...
public final class DialogCreateOptionProductBinding implements ViewBinding {
  @NonNull
  ...
  private DialogCreateOptionProductBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imgAvartar, @NonNull ConstraintLayout imgCamera,
  ...
  @NonNull
  public static DialogCreateOptionProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogCreateOptionProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_create_option_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogCreateOptionProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imgCamera;
      ConstraintLayout imgCamera = ViewBindings.findChildViewById(rootView, id);
      if (imgCamera == null) {
        break missingId;
      }
      ...
      return new DialogCreateOptionProductBinding((ConstraintLayout) rootView, btnHuy, btnLuu,
