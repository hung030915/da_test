...
public final class ActivityAddAddressBinding implements ViewBinding {
  ...
  private ActivityAddAddressBinding(@NonNull ConstraintLayout rootView, @NonNull TextView btnSave,
      ...
      @NonNull LinearLayout linearLayout, @NonNull Spinner spnCity, @NonNull Spinner spnDistrict,
      @NonNull Spinner spnWard) {
  ...
  public static ActivityAddAddressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddAddressBinding((ConstraintLayout) rootView, btnSave, chkChooseDefault,
          edtAddress, edtPhoneNumber, edtUsername, imgBack, linearLayout, spnCity, spnDistrict,
          spnWard);
    }
