...
import com.example.s_shop.model.body.PurchaseBody;
import com.example.s_shop.model.response.BannerReponse;
import com.example.s_shop.model.response.CartReponse;
import com.example.s_shop.model.response.CheckStoreResponse;
import com.example.s_shop.model.response.CreateProductResponse;
import com.example.s_shop.model.response.DetailProductResponse;
import com.example.s_shop.model.response.DetailUserReponse;
import com.example.s_shop.model.response.InfoResponse;
import com.example.s_shop.model.response.ListChatResponse;
import com.example.s_shop.model.response.ListCommentResponse;
import com.example.s_shop.model.response.ListMessageResponse;
import com.example.s_shop.model.response.ListNotifiReponse;
import com.example.s_shop.model.response.OrderResponse;
import com.example.s_shop.model.response.ProductBestSellerResponse;
import com.example.s_shop.model.response.ProductByCategoryReponse;
//import com.example.s_shop.model.response.RevenueByMonthResponse;
import com.example.s_shop.model.response.ServerResponse;
import com.example.s_shop.model.response.LoginResponse;
import com.example.s_shop.model.response.ProductResponse;
import com.example.s_shop.model.response.ProductTypeResponse;
import com.example.s_shop.model.response.StoreIdResponse;
import com.example.s_shop.model.response.statistical.RevenueByMonthResponse;
import com.example.s_shop.model.response.statistical.SoldQuantityProductResponse;
import com.example.s_shop.model.response.store.DetailBills;
import com.example.s_shop.model.response.store.InfoStore;
import com.example.s_shop.model.response.store.ResponseBill;
